...
class TorchScriptScalerWrapper(nn.Module):
    """
    ...
    def export(
        ...
        **kwargs
        ...
        Args:
            ...
            input_sample: Sample input for tracing (optional, uses scripting if not provided)
        ...
        if scaler is not None:
            model = TorchScriptScalerWrapper(model, scaler)
